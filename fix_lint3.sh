...
sed -i 's/import { Screw, BeveledBox } from ".\/utils";/import { BeveledBox } from ".\/utils";/g' src/experience/camera/CameraBody.tsx
sed -i 's/import { Screw, BeveledBox } from ".\/utils";/import { BeveledBox } from ".\/utils";/g' src/experience/camera/RearPower.tsx
sed -i 's/import { Screw, BeveledBox } from ".\/utils";/import { BeveledBox } from ".\/utils";/g' src/experience/camera/TopRig.tsx
...
cat << 'INNEREOF' > src/experience/camera/CinemaCamera.tsx
"use client";
